...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        CustomAuthenticationFilter customAuthenticationFilter =
                new CustomAuthenticationFilter(adminRepository, authenticationManager(null), algorithmUtil());

        CustomAuthorizationFilter customAuthorizationFilter =
                new CustomAuthorizationFilter(algorithmUtil(), adminRepository);
        ...
        http.authorizeHttpRequests(request ->{
            ...
            request.requestMatchers(HttpMethod.GET, "/api/admin/token/refresh","/api/project/filterProjects/**").permitAll();
            ...
            request.requestMatchers(HttpMethod.PUT,
                    "/api/project/editProject/**").hasAnyAuthority("ROLE_ADMIN");
        });
    ...
    public CorsConfigurationSource corsConfigurationSource(){
        ...
        corsConfiguration.setAllowedHeaders(List.of("Authorization","Access-Control-Allow-Origin","Content-Type","Cookie"));
